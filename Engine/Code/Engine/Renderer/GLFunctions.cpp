...
bool wglGetTypedProcAddress( T *out, char const *name )
{
    ...
    *out = (T) wglGetProcAddress( name );
    ...
    if( ( *out ) == nullptr )
    {
        // if it is not part of wgl (the device), then attempt to get it from the DLL library
...
//------------------------------------------------------------------------
bool GLCheckError( char const *file, char const *func, int line )
{
#if defined(_DEBUG)
...
void GLFunctions::FreeGLLibrary()
{
